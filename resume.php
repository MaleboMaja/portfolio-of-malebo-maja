                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                <div class="page-title text-center">
                                    ...
                                    <p>A software developer from Pretoria, who focuses on interactive design &amp; clean interfaces. A freelance designer focusing on full stack development.  </p>
                                </div>
                            </div>
                        </div> <!-- /.row -->
                                    ...
                                    <div class="history-scroller">
                                        <div class="history-item">
                                            ...
                                            <div class="history-text">
                                                <h5>Richfield Graduate Institute of Technology</h5>
                                                <span>2018 - 2020</span>
                                            </div>
                                        </div>
                                        <!-- /.history-item -->
