                ...
                <div class="pt-tablecell page-works relative">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                <div class="page-title text-center">
                                    ...
                                    <p>A software development from Pretoria, who focuses on interactive design &amp; clean interfaces. A freelance designer focusing on full stack development. </p>
                            </div>    
                            </div>                        
                        </div> <!-- /.row -->
                        ...
                        <div class="row isotope-gutter">
                            <div class="col-xs-12 col-sm-6 col-md-4 Illustrator Web-Design">
                                <figure class="works-item">
                                    <img src="img/works/1.jpg" alt="">
                                    <div class="overlay"></div>
                                    <figcaption class="works-inner">
                                        <h4>Online Shopping</h4>
                                        <p>Illustration, front-end </p>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4 Web-Design Illustrator">
                                <figure class="works-item">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 Games">
                                <figure class="works-item">
