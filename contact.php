                            ...
                            <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                                <div class="contact-block">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Email</h4>
                                            <p><a href="mailto:majamalebo620@gmail.com">majamalebo620@gmail.com</a></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.contact-block -->
                                <div class="contact-block">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4>Phone</h4>
                                            <p><a href="tel:+276-7626-8475">+276-7626-8475</a></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="contact-social">
                                    <li>
                                        ...
                                        <a href="www.fb.com/malebo muntuza maja"><i class="tf-ion-social-facebook"></i></a>
                                    </li>
                                    <li>
                                        <span class="contact-social-hex"></span>
                                        <a href="www.twitter.com/malebo_maja"><i class="tf-ion-social-twitter"></i></a>
                                    </li>
                                    <li>
                                        <span class="contact-social-hex"></span>
                                    ...
                                    <li>
                                        <span class="contact-social-hex"></span>
                                        <a href="www.dribbble.com/malebomaja"><i class="tf-ion-social-dribbble"></i></a>
                                    </li>
                                </ul>
                            </div>
