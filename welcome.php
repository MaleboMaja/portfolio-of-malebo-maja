                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6 col-lg-7">
                                <div class="page-title">
                                    <h2>Malebo <span class="primary">Maja</span> <span class="title-bg">About</span></h2>
                                    <p><p>A software developer from Pretoria, who focuses on interactive design &amp; clean interfaces. A freelance designer focusing on full stack development. </p>
                                </div>
                            </div>
                        </div> <!-- /.row -->
                    </div> <!-- /.container -->
